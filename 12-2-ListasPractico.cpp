...
void mostrarDatoEspanol(Libro p){
    if(p.espanol){
        cout << "\nISBN: " << p.isbn << endl;
        cout << "Titulo: " << p.titulo << endl;
        cout << "Autor: " << p.autor << endl;
...
void mostrarDatoMisterio(Libro p){
...
int main(){
    ...
    do{
        ...
        cout << "\t11) Mostrar de misterio\t12) Eliminar libros de ciencia ficcion\n";
        cout << "\t13) Salir\n";
        cout << "\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
            ...
            case 10: mostrarEsp(); break;
            case 11: mostrarMist(); break;
            case 12: eliminarCF(); break;
