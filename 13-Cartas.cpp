...
void mostrarCarta(Carta unaCarta){
    if (unaCarta.numero > 0 && unaCarta.numero < 10){
        cout << unaCarta.numero+1;
        
    }
    else{
        switch (unaCarta.numero){
            case 10: cout << "Sota"; break;
            case 11: cout << "Reina"; break;
            case 12: cout << "Rey"; break;
            case 13: cout << "As"; break;
        }
    ...
    switch (unaCarta.palo){
        case Corazones: cout << "corazones roja"; break;
        case Diamantes: cout << "diamantes roja"; break;
        case Treboles: cout << "treboles negra"; break;
        case Picas: cout << "picas negra"; break;
    }
